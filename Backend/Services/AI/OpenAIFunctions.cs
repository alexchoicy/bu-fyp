...
public static class OpenAIFunctions
{
    ...
    {
        public static async Task<CourseResponseDto?> GetCourseByCodeAndNumber(AppDbContext dbContext, string code, string courseNumber)
        {
            ...
            var latestVersion = course.CourseVersions
            ...
            var dto = new CourseResponseDto
            {
                ...
                Versions = latestVersion != null ? new List<CourseVersionResponseDto>
                {
                    new CourseVersionResponseDto
                    {
                        ...
                        FromTerm = new TermResponseDto { Id = latestVersion.FromTermId, Name = latestVersion.FromTerm?.Name ?? "" },
                        ToYear = latestVersion.ToYear,
                        ToTerm = latestVersion.ToTerm != null ? new TermResponseDto { Id = latestVersion.ToTermId ?? 0, Name = latestVersion.ToTerm.Name } : null,
                        Assessments = latestVersion.Assessments.Select(a => new AssessmentResponseDto
                        {
                            Id = a.Id,
                            Name = a.Name,
                        ...
                        MediumOfInstruction = latestVersion.CourseVersionMediums
    ...
    public static class SystemPrompts
    {
        ...
        public const string ExtractCILOs = @"You are an expert in extracting Course Intended Learning Outcomes (CILOs) from academic documents.
        ...
        public const string ChatAssistant = @"System: You are a helpful academic advisor assistant for a university. 
