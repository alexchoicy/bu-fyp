...
<template>
  <div class="container mx-auto py-8 max-w-4xl space-y-2">
    ...
    <UiCoursePdfParse
      ...
      v-model:course-version-data="courseVersionData"
      ...
      <CardContent class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <Input
              id="courseNumber"
              v-model="createCourseData.courseNumber"
    ...
    <UiCourseVersionsCourseSelection
      v-model="courseVersionData.preRequisiteCourseVersionIds!"
