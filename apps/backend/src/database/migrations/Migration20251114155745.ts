...
export class Migration20251114155745 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "student_course" ("id" bigserial primary key, "student_id" bigint not null, "course_id" bigint not null, "status" text not null, "grade" text not null, "term" text not null, "year" text not null);`);
